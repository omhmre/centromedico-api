...
func (a *App) GetEgresos(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		Responder(w, http.StatusBadRequest, models.Respuesta{Status: "error", Msg: "datos de fecha invalidos"})
		return
	}
...
func (a *App) PostEgreso(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		Responder(w, http.StatusBadRequest, models.Respuesta{Status: "error", Msg: "datos de egreso invalidos"})
		return
	}
...
func (a *App) DelEgreso(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		Responder(w, http.StatusBadRequest, models.Respuesta{Status: "error", Msg: "ID invalido"})
		return
	}
